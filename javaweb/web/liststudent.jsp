...
<div class="container">
    <h2>学生列表</h2>
    <a href="${pageContext.request.contextPath}/addstudent.jsp" class="action-btn">添加学生</a>
    ...
    <table>
        ...
        <c:forEach items="${students}" var="student">
            <tr>
                ...
                <td>${student.age}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/deletestudent?no=${student.no}"
                       onclick="return confirm('确定要删除吗？')" class="action-btn">删除</a>
                    <a href="${pageContext.request.contextPath}/updatestudent?no=${student.no}&name=${student.name}&age=${student.age}" class="action-btn">编辑</a>
                </td>
            </tr>
        </c:forEach>
    ...
    <div class="pagination">
        <c:forEach begin="1" end="${totalPages}" var="i">
            <a href="${pageContext.request.contextPath}/liststudent?page=${i}">${i}</a>
        </c:forEach>
    </div>
</div>
</body>
